...
In the 5 subfolders here, including `2MVC`, `3I3Z`, `4EY1`, `4EY9`, and `4EYD`, we maintain the input and output files of the H++ server for preparing different structures of the insulin wildtype. Note that each of the wildtype structures were prepared at different pH values to have the same amount of total charges. Below we summarize some details of preparing these structures for the MD simulations. 
