...
if __name__ == "__main__":
    ...
    plt.fill_between([0.02, 0.17], 2, 8, color=colors[0], alpha=0.3, zorder=0)
    plt.fill_between([0.02, 0.17], 8, 12.5, color=colors[1], alpha=0.3, zorder=0)
    plt.fill_between([0.02, 0.17], 12.5, 26, color=colors[2], alpha=0.3, zorder=0)
    ...
    plt.fill_between([0, 0.17], 2, 8, color=colors[0], alpha=0.3, zorder=0)
    plt.fill_between([0, 0.17], 8, 12.5, color=colors[1], alpha=0.3, zorder=0)
    plt.fill_between([0, 0.17], 12.5, 26, color=colors[2], alpha=0.3, zorder=0)
