...
class RamachandranAnalyzer:
    ...
    def beta_sheet_fraction(self, rama_points):
        ...
        Parameters
        ----------
        rama_points (np.ndarray): An N by 2 numpy array containing the coordinates of
...
if __name__ == "__main__":
    ...
    for r in args.res:
        ...
        if os.path.isfile(f"{args.dir}{args.sys.lower()}_rama_res{r}.pickle") is True:
            ...
            u_1 = trajs[0]
            region_1 = u_1.select_atoms(f"resid {r - 1}")
            ...
            for i in range(2, 14):
                if trajs[i - 1] == "missing":
                    ...
                    u_2 = trajs[i - 1]
                    region_2 = u_2.select_atoms(f"resid {r - 1}")
        ...
        L.logger(
            f"Calcuting the percentage of the poitns in the beta-sheet region ...\n"
        )
