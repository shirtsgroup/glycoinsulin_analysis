...
if __name__ == "__main__":
    ...
    c1, _ = scipy.stats.kendalltau(B24_avg, exp_h)
    c2, _ = scipy.stats.kendalltau(B25_avg, exp_h)

    e1 = bootstrapping_sample(B24_sasa, exp_h, exp_err)
    e2 = bootstrapping_sample(B25_sasa, exp_h, exp_err)
